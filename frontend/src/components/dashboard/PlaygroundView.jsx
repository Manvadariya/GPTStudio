...
export function PlaygroundView() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Use streaming for fast and gpt-oss models
      if (modelConfig.model === 'fast-model' || modelConfig.model === 'qwen-fast' || modelConfig.model === 'gpt-oss') {
